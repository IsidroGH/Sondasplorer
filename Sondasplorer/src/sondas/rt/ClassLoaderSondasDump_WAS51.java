...
public class ClassLoaderSondasDump_WAS51 implements Opcodes {
...
cw.visit(V1_4, ACC_PUBLIC + ACC_SUPER + ACC_ABSTRACT, "java/lang/ClassLoader", null, "java/lang/Object", null);

cw.visitInnerClass("java/lang/ClassLoader$1", null, null, 0);

cw.visitInnerClass("java/lang/ClassLoader$2", null, null, ACC_STATIC);

cw.visitInnerClass("java/lang/ClassLoader$3", null, null, ACC_STATIC);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "resolveClass", "(Ljava/lang/Class;)V", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL + ACC_DEPRECATED, "defineClass", "([BII)Ljava/lang/Class;", null, new String[] { "java/lang/ClassFormatError" });
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitInsn(ACONST_NULL);
mv.visitVarInsn(ALOAD, 1);
...
{
mv = cw.visitMethod(ACC_PRIVATE, "checkName", "(Ljava/lang/String;Z)Z", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 1);
Label l0 = new Label();
mv.visitJumpInsn(IFNULL, l0);
...
mv.visitVarInsn(ALOAD, 1);
mv.visitInsn(ICONST_1);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "checkName", "(Ljava/lang/String;Z)Z");
Label l0 = new Label();
mv.visitJumpInsn(IFNE, l0);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "findLoadedClass", "(Ljava/lang/String;)Ljava/lang/Class;", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "check", "()V");
mv.visitVarInsn(ALOAD, 0);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "findSystemClass", "(Ljava/lang/String;)Ljava/lang/Class;", null, new String[] { "java/lang/ClassNotFoundException" });
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "check", "()V");
mv.visitMethodInsn(INVOKESTATIC, "java/lang/ClassLoader", "getSystemClassLoader", "()Ljava/lang/ClassLoader;");
...
{
mv = cw.visitMethod(ACC_PUBLIC, "loadClass", "(Ljava/lang/String;)Ljava/lang/Class;", null, new String[] { "java/lang/ClassNotFoundException" });
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitVarInsn(ALOAD, 1);
mv.visitInsn(ICONST_0);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_SYNCHRONIZED, "loadClass", "(Ljava/lang/String;Z)Ljava/lang/Class;", null, new String[] { "java/lang/ClassNotFoundException" });
mv.visitCode();
Label l0 = new Label();
Label l1 = new Label();
Label l2 = new Label();
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "defineClass", "(Ljava/lang/String;[BII)Ljava/lang/Class;", null, new String[] { "java/lang/ClassFormatError" });
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitVarInsn(ALOAD, 1);
mv.visitVarInsn(ALOAD, 2);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "setSigners", "(Ljava/lang/Class;[Ljava/lang/Object;)V", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "check", "()V");
mv.visitVarInsn(ALOAD, 1);
...
{
mv = cw.visitMethod(ACC_PROTECTED, "findResources", "(Ljava/lang/String;)Ljava/util/Enumeration;", null, new String[] { "java/io/IOException" });
mv.visitCode();
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_FINAL, "getResources", "(Ljava/lang/String;)Ljava/util/Enumeration;", null, new String[] { "java/io/IOException" });
mv.visitCode();
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "getSystemResources", "(Ljava/lang/String;)Ljava/util/Enumeration;", null, new String[] { "java/io/IOException" });
mv.visitCode();
mv.visitMethodInsn(INVOKESTATIC, "java/lang/ClassLoader", "getSystemClassLoader", "()Ljava/lang/ClassLoader;");
mv.visitVarInsn(ASTORE, 1);
mv.visitVarInsn(ALOAD, 1);
...
{
mv = cw.visitMethod(ACC_PROTECTED + ACC_FINAL, "defineClass", "(Ljava/lang/String;[BIILjava/security/ProtectionDomain;)Ljava/lang/Class;", null, new String[] { "java/lang/ClassFormatError" });
mv.visitCode();
...
mv.visitLdcInsn("Sondas - WAS 5.1 Instrumentalizado");
mv.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V");
*/
// Fin Instrumentalizacion
...
Label l4 = new Label();
Label l5 = new Label();
mv.visitTryCatchBlock(l3, l4, l5, "java/lang/ClassFormatError");
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "check", "()V");
mv.visitVarInsn(ALOAD, 1);
Label l6 = new Label();
...
mv.visitVarInsn(ILOAD, 4);
mv.visitVarInsn(ALOAD, 5);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/ClassLoader", "defineClass0", "(Ljava/lang/String;[BIILjava/security/ProtectionDomain;)Ljava/lang/Class;");
mv.visitVarInsn(ASTORE, 6);
mv.visitLabel(l1);
Label l10 = new Label();
mv.visitJumpInsn(GOTO, l10);
...
mv.visitVarInsn(ALOAD, 7);
mv.visitVarInsn(ALOAD, 8);
mv.visitMethodInsn(INVOKESPECIAL, "java/lang/Package", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/URL;)V");
mv.visitVarInsn(ASTORE, 10);
mv.visitVarInsn(ALOAD, 0);
mv.visitFieldInsn(GETFIELD, "java/lang/ClassLoader", "packages", "Ljava/util/HashMap;");
mv.visitVarInsn(ALOAD, 1);
